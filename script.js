...
function playGotGot() {
  var audio = new Audio(
    "https://cdn.glitch.global/9db1163b-024c-40fd-b302-a4340985e8af/Got%20got.m4a?v=1646965420264"
  );
  audio.play();
}
...
function playLetsGo() {
  var audio = new Audio(
    "https://cdn.glitch.global/9db1163b-024c-40fd-b302-a4340985e8af/Lets%20Go.m4a?v=1646963856385"
  );
  audio.play();
}
...
function playBoatsAndLogs() {
  var audio = new Audio(
    "https://cdn.glitch.global/9db1163b-024c-40fd-b302-a4340985e8af/boats%20and%20logs.m4a?v=1646965006611"
  );
  audio.play();
}
...
function playUhOh() {
  var audio = new Audio(
    "https://cdn.glitch.global/9db1163b-024c-40fd-b302-a4340985e8af/Uh%20oh.m4a?v=1646965407020"
  );
  audio.play();
}
...
//         }
//     }
// // </script>https://interactive-examples.mdn.mozilla.net/media/cc0-audio/t-rex-roar.mp3
// var audio = new Audio(
//   "https://interactive-examples.mdn.mozilla.net/media/cc0-audio/t-rex-roar.mp3"
// );
// https://interactive-examples.mdn.mozilla.net/media/cc0-audio/t-rex-roar.mp3
